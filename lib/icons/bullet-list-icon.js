...
export const tagName = "bullet-list-icon";
export class BulletListIcon extends LitElement {
    render() {
...
BulletListIcon.styles = [iconStyles];
//# sourceMappingURL=bullet-list-icon.js.map