...
var _MarkdownTextarea_markdownMap;
...
let MarkdownTextarea = class MarkdownTextarea extends LitElement {
    constructor() {
        super();
        _MarkdownTextarea_markdownMap.set(this, void 0);
        ...
        Object.defineProperty(this, "handleHeaderClick", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: (event) => {
                ...
                if (!(target instanceof HTMLElement))
                    throw TypeError();
                const id = target.id;
                const markdownSymbol = (_a = __classPrivateFieldGet(this, _MarkdownTextarea_markdownMap, "f").get(id)) !== null && _a !== void 0 ? _a : "";
        ...
        Object.defineProperty(this, "handleModifierClick", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: (event) => {
        ...
        Object.defineProperty(this, "handleTemplateClick", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: (event) => {
        ...
        __classPrivateFieldSet(this, _MarkdownTextarea_markdownMap, new Map([
            ["h1", "#"],
            ["h2", "##"],
            ["h3", "###"],
            ["h4", "####"],
...
_MarkdownTextarea_markdownMap = new WeakMap();
Object.defineProperty(MarkdownTextarea, "styles", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: [globalStyles, formStyles, markdownStyles]
});
__decorate([
    property({ attribute: "name" })
], MarkdownTextarea.prototype, "name", void 0);
__decorate([
    property({ attribute: "required", type: Boolean })
], MarkdownTextarea.prototype, "required", void 0);
__decorate([
    query("textarea")
], MarkdownTextarea.prototype, "textarea", void 0);
MarkdownTextarea = __decorate([
